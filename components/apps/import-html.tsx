...
import { Upload, Save, Trash2, FileCode } from 'lucide-react'
...
export default function ImportHtml({ username }: ImportHtmlProps) {
  ...
  // Load saved HTML apps from user account
  useState(() => {
    if (username) {
      ...
      {!selectedApp ? (
        <>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-32 p-3 rounded-md border border-border bg-background text-foreground font-mono text-sm resize-none focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">Saved HTML Apps</h3>

            {savedApps.length === 0 ? (
              <div className="text-center py-12 text-muted-foreground">
                <FileCode className="w-16 h-16 mx-auto mb-4 opacity-50" />
                <p>No saved HTML apps yet</p>
        ...
        // Render selected HTML app in iframe
        <div className="h-full flex flex-col">
